...
const FloatingPaths = memo(function FloatingPaths({
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      <svg
        className="h-full w-full text-primary-950/40 dark:text-white/40"
        fill="none"
...
export default memo(function BackgroundPaths({
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-white dark:bg-dark-950">
